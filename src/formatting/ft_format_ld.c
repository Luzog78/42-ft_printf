...
/*   Updated: 2023/11/05 05:37:25 by ysabik           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	ft_setup(t_arg *arg, va_list *args, long *nbr, t_signed_size *count)
{
	if (arg->width == -2)
...
static t_signed_size	ft_zero_filling(t_arg *arg, long nbr, char spacing)
{
	t_signed_size	len;
